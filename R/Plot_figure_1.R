...
g2b <-
  ...
  labs(y = "Frequency", x = "Successful species (%)") +
...
g2c <-
  ...
  annotate(geom = "text", x = 42.5, y = 2.3, label = "N = 450", hjust = 0) +
  annotate(geom = "text", x = 42.5, y = 1.3, label = "N = 1112", hjust = 0) +
  ...
  labs(y = "Number of seeded species", 
       x = "Number of successful species",
       title = "") +
...
ggout
ggsave(ggout, filename = "outputs/figures/Figure_1_BC.png", width = 11.8, height = 5)
